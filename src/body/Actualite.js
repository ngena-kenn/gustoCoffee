    ...
    render(){
        return(
            <div>
                ...
                <div className="forme">
                    <div className="valeur2"></div>
                    <div>
                        <div className="text1">Fresh food everyday</div>
                        <div className="text2">LORSQUE DARK RIME AVEC QUALITÉ</div>
                        <div className="text3">
                ...
                <div className="forme">
                    <div>
                        ...
                        <div className="text2">CHEZ DARK KITCHEN, <br></br>NOUS LUTTONS CONTRE LE GASPILLAGE ALIMENTAIRE </div>
                        <div className="text3">
                    ...
                    <div className="valeur3"></div>
                    <div className="forme">
                    <div className="valeur4"></div>
                    <div>
                        <div className="text1">Good vibes only</div>
                        <div className="text2">“ALOHA” ANCRÉ CHEZ DARK KITCHEN</div>
                        <div className="text3">
                            <p>Inutile de prendre l'avion pour arriver à Hawaï,
                               <br></br>  atterrissez directement dans nos restaurants 
                                <br></br> et emparez-vous des good vibes Dark kitchen !</p>
